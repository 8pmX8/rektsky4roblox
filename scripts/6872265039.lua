...
getcustomassetfunc("rektsky/sound/mc/bedbreak.mp3")
getcustomassetfunc("rektsky/sound/mc/tntexplode.mp3")
getcustomassetfunc("rektsky/sound/mc/tnthiss.mp3")
getcustomassetfunc("rektsky/sound/mc/glassbreak.mp3")
getcustomassetfunc("rektsky/sound/mc/breakwood.mp3")
getcustomassetfunc("rektsky/sound/mc/woolbreak.mp3")
getcustomassetfunc("rektsky/sound/mc/buyitem.mp3")
getcustomassetfunc("rektsky/sound/mc/pickup.mp3")
